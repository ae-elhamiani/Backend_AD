...
//            "/client-service/banking/packs/[^/]+$",
//            "/client-service/banking/signup",
//            "/client-service/banking/otp-email",
//            "/client-service/banking/phone",
//            "/client-service/banking/otp-phone",
//            "/client-service/api/[^/]+$",
//
//
//
...
//            return chain.filter(exchange);
//        } else {
//            log.info("No cookie present in the request.");
//            return unauthorizedResponse(exchange);
//
//        }
//    }
